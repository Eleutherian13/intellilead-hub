...
export function LeadDossier({ lead, onBack, onStatusChange }: LeadDossierProps) {
  ...
  const statuses: Lead["status"][] = ["new", "assigned", "contacted", "converted", "rejected"];
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground">
                  {lead.company.industry} • {lead.company.subIndustry}
                </p>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="flex items-center justify-center mb-6">
              ...
              >
                <span
                  className={cn("text-4xl font-bold", getScoreColor(lead.score.total))}
                >
                  {lead.score.total}
                </span>
              ...
              {[
                ...
                <div key={score.label}>
                  ...
                  <div className="h-2 rounded-full bg-secondary overflow-hidden">
                    <div
                      className={cn("h-full rounded-full transition-all duration-500", getProgressColor(score.value))}
