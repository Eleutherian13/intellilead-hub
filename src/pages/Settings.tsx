              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="email" type="email" defaultValue="rahul.sharma@company.com" />
                  </div>
                  <div className="space-y-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {[
                    { label: "High Priority Leads", description: "Leads with score 80+", enabled: true },
                    { label: "New Tender Alerts", description: "Government tender publications", enabled: true },
